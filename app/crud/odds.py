...
def list_odds(
    ...
    stmt = stmt.order_by(Odds.captured_at.asc(), Odds.odds_id.asc()).limit(limit).offset(offset)
...
def list_odds_page(
    ...
    base = _odds_base_query(match_id, bookmaker_id, selection_id, ts_from, ts_to, market_code)
    ...
    # page items
    page_stmt = base.order_by(Odds.captured_at.asc(), Odds.odds_id.asc()).limit(limit).offset(offset)
